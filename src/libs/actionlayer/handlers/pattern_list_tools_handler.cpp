...
ActionResult handleListTools(const QJsonObject &args, const ActionContext &ctx)
{
    ...
    tools.append(QStringLiteral("pattern.undo"));                 // Phase 12 (22 Aug, 2026): one-directional, history-based, save-survivable undo, implemented in history_undo_handlers.cpp.
